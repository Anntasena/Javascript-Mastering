...
/*
*-> .includes():
    @- Digunakan untuk memeriksa keberadaan nilai tertentu dalam array atau string.
    @- Sederhana dan langsung, tanpa memerlukan callback function.
*-> .some():
    @- Digunakan untuk memeriksa apakah setidaknya satu elemen dalam array memenuhi kondisi yang diberikan oleh callback function.
    @- Lebih fleksibel karena bisa menggunakan kondisi kompleks dalam callback.
*/
...
*-> .some():
    ...
    @- Mengembalikan true jika salah satu elemen memenuhi kondisi.
*-> .every():
    @- Digunakan untuk memeriksa apakah semua elemen dalam array memenuhi kondisi yang ditentukan.
    @- Mengembalikan true hanya jika semua elemen memenuhi kondisi.
*/

//# separator callback
// dalam praktek nyata hal seperti ini sering digunakanakn karena membuat kode menjadi DRY (dont repeat yourself)
