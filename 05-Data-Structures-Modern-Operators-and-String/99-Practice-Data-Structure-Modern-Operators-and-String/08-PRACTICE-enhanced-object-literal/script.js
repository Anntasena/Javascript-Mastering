...
//! Di bawah ini adalah array bookData yang berisi array lainnya. Setiap array bagian dalam terdiri dari nama properti (elemen pertama), dan nilai (elemen kedua). Misalnya, dalam ['title', 'Computer Networking: A Top-Down Approach'], 'title' adalah nama properti, dan 'Computer Networking: A Top-Down Approach' dimaksudkan sebagai nilai yang ditetapkan untuk nama properti tersebut.
//! Dengan menggunakan properti yang dihitung, isi objek newBook ​​dengan properti dan nilai dari array bookData. Yang pertama sudah selesai.
const bookData = [
...
//! Berikut adalah variabel halaman. Tambahkan variabel tersebut sebagai properti objek newBook2. Gunakan cara yang lebih singkat.
const pages = 880;
