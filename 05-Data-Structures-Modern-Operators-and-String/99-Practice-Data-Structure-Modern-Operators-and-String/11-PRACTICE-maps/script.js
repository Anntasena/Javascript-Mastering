...
//! Buat buku baru, tetapi kali ini, sebagai Peta. Tetapkan ke variabel bookMap. Gunakan array ini sebagai data awal:
...
//! Tetapkan kunci baru di bookMap yang disebut halaman, dan tetapkan dengan angka 464.
bookMap.set('pages', 464)
console.log(bookMap);

//! Dapatkan nilai judul dan penulis dari bookMap, lalu catat ke konsol string yang diformat seperti itu: "${title} oleh ${author}".
console.log(`${bookMap.get('title')} by ${bookMap.get('author')}`)

//! Dapatkan ukuran bookMap dan catat pada konsol.
console.log(bookMap.size);

//! Periksa apakah bookMap mempunyai kunci penulis. Jika ya, catat "Penulis buku diketahui" ke konsol.
bookMap.has('author') ? console.log('The author of the book is known') : console.log('The author is unknown');