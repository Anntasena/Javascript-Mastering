...
//! Setiap objek buku mempunyai properti penulis, yang menyimpan array string (nama penulis) jika ada beberapa penulis, atau string tunggal (nama penulis) jika hanya ada satu penulis.
//! Deklarasikan array bernama bookAuthors, dan isi dengan penulis dari dua buku pertama dari array books. Array bookAuthors seharusnya hanya memiliki satu level (tidak ada array bersarang).
const bookAuthors = [...books[0].author, ...books[1].author]
console.log(bookAuthors);

//! Tulis fungsi bernama spellWord yang menerima string tunggal sebagai argumen. Fungsi ini harus mencatat ke konsol setiap huruf argumen yang dipisahkan oleh spasi.
books[books.length-1].spellword(`javascript`)